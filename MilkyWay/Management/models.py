...
class Users(models.Model):
    ...
    phone_number = models.CharField(max_length=500, blank=False) 
...
class Tour(models.Model):
    ...
    description = models.TextField(max_length=500)  # Mô tả tour
    ...
    price = models.CharField(max_length=255)  # Giá tour
    available_seats = models.CharField(max_length=255)  # Số lượng chỗ trống
    remaining_seats = models.CharField(max_length=255, null=True) # Số lượng chỗ còn lại
    ...
    def save(self, *args, **kwargs):
        ...
        # self.start_date = encrypt_data(self.start_date)
        # self.end_date = encrypt_data(self.end_date)
        self.price = encrypt_data(self.available_seats)
...
class Booking(models.Model):
    ...
    status = models.CharField(max_length=100, choices=STATUS_CHOICES, default='booked')  # Trạng thái
...
class Payment(models.Model):
    ...
    amount = models.CharField(max_length=200)  # Số tiền thanh toán
    payment_date = models.DateTimeField(auto_now_add=True)  # Ngày thanh toán
    payment_method = models.CharField(max_length=200, choices=STATUS_METHOD, default="cash")  # Phương thức thanh toán
    payment_state = models.CharField(max_length=200, choices=STATUS_CHOICES, default="unpaid") 
    def __str__(self):
...
class Tickets(models.Model):
    ...
    ticket_code = models.CharField(max_length=500)
