...
class User(AbstractUser):
    ...
    address = models.CharField(max_length=255, blank=True)  # Địa chỉ (tùy chọn)
...
class Booking(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)  # Người đặt vé (khách hàng)
...
class Review(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)  # Người đánh giá
